# RQ016B-F1 WOD and OnSite feasibility audit
...
`rq015a_full479_projected` contents: `WOD_PROJ` row count is 906; `segment_key` 906/906 non-null and `candidate_index` 906/906 non-null. `WOD_K2` row count is 906; `canonical_key` and `product_row_key` are each 906/906 non-null and 906 unique, while `case_id` and `frame_id` are 0/906 non-null. The source file for these counts is `data/derived/rq015k_logdomain_gate/l1_v1/artifact_id=wod_rq010b_full479_audited`, columns `canonical_key`, `product_row_key`, `case_id`, `frame_id`.
...
| Sampling rate and timestep | AVAILABLE as observed timestamps | `ONSITE_DENSE` has `timestamp_ms` and `frame_index` 70,317/70,317 non-null. The most frequent adjacent within-case timestamp gap is 100 ms: 36258/70050 adjacent gaps, filter rows sorted by `case_key,timestamp_ms,frame_index`. |
...
Single-anchor coverage source `reports/studies/RQ012_onsite_event_annotation_readiness/RQ012B_2_harm_association_20260627T095847+0800_8454ad93/02_process/03_event_deviation/onsite_ipv/coverage.json`: `units_requested=285`, `units_with_anchors=267`, `total_av_anchors=267`, `max_anchors_per_unit=1`, `ipv_frame_rows=70317`.

All-valid coverage source `reports/studies/RQ012_onsite_event_annotation_readiness/RQ012B_2_harm_association_20260627T095847+0800_8454ad93/02_process/03_event_deviation/hpc_onsite_ipv/process_allvalid_processpool_amd/coverage.json`: `total_av_anchors=67861`, `valid_anchor_candidate_total=68420`, `valid_anchor_candidates_after_cap=68420`, `anchors_excluded_by_cap=0`.
...
|---|---|---|---|---|---|
| `elapsed_time_s` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::elapsed_time_s` 67861/67861 non-null. |
| `history_row_count` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::history_row_count` 67861/67861 non-null. |
| `ego_vx_anchor` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::ego_vx_anchor` 67861/67861 non-null. |
| `ego_vy_anchor` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::ego_vy_anchor` 67861/67861 non-null. |
| `ego_heading_anchor` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::ego_heading_anchor` 67861/67861 non-null. |
| `counterpart_vx_anchor` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::counterpart_vx_anchor` 67861/67861 non-null. |
| `counterpart_vy_anchor` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::counterpart_vy_anchor` 67861/67861 non-null. |
| `counterpart_heading_anchor` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::counterpart_heading_anchor` 67861/67861 non-null. |
| `relative_dx_anchor` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::relative_dx_anchor` 67861/67861 non-null. |
| `relative_dy_anchor` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::relative_dy_anchor` 67861/67861 non-null. |
| `relative_distance_anchor` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::relative_distance_anchor` 67861/67861 non-null. |
| `relative_dvx_anchor` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::relative_dvx_anchor` 67861/67861 non-null. |
| `relative_dvy_anchor` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::relative_dvy_anchor` 67861/67861 non-null. |
| `relative_speed_anchor` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::relative_speed_anchor` 67861/67861 non-null. |
| `closing_rate_anchor` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::closing_rate_anchor` 67861/67861 non-null. |
| `heading_difference_anchor` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::heading_difference_anchor` 67861/67861 non-null. |
| `relative_distance_mean_wx` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::relative_distance_mean_wx` 67861/67861 non-null. |
| `relative_distance_std_wx` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::relative_distance_std_wx` 67861/67861 non-null. |
| `relative_speed_mean_wx` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::relative_speed_mean_wx` 67861/67861 non-null. |
| `closing_rate_mean_wx` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::closing_rate_mean_wx` 67861/67861 non-null. |
| `closing_ttc_anchor` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::closing_ttc_anchor` 31740/67861 non-null. |
| `apet_online_proxy` | numeric | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::apet_online_proxy` 5364/67861 non-null. |
| `geometry_path_category` | categorical | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::geometry_path_category` 67861/67861 non-null. Note: heuristic OnSite mapping, not InterHub audited source label. |
| `geometry_path_relation` | categorical | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::geometry_path_relation` 67861/67861 non-null. Note: heuristic OnSite mapping, not InterHub audited source label. |
| `turn_pair_label` | categorical | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::turn_pair_label` 67861/67861 non-null. Note: heuristic OnSite mapping, not InterHub audited source label. |
| `agent_type_pair` | categorical | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::agent_type_pair` 67861/67861 non-null. |
| `vehicle_type_list` | categorical | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::vehicle_type_list` 67861/67861 non-null. |
| `av_included` | categorical | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::av_included` 67861/67861 non-null. |
| `priority_role` | categorical | MISSING | Local WOD package has only segment_key, candidate_index, ego_ipv, ego_ipv_error plus K2 bookkeeping; no paired trajectory, timing window, map/reference-line, or RQ009 context columns. | AVAILABLE | `OS_ALLVALID_M3::priority_role` 67861/67861 non-null. Note: heuristic OnSite mapping, not InterHub audited source label. |
...
|---|---:|---:|---|
| A. All aligned frames | physical frame | 70317 | `ONSITE_DENSE`, all rows; columns `case_key`, `frame_index`, `timestamp_ms` |
| B. All RQ009 timing-valid anchor frames, current materialized scope | anchor frame | 67861 | `ONSITE_ALLVALID_M3`, all rows |
| B'. Candidate count before failed-unit loss | candidate anchor | 68420 | all-valid `coverage.json`, field `valid_anchor_candidate_total` |
| C. Continue one anchor per unit | anchor frame | 267 | `ONSITE_SINGLE_M3`, all rows |
...
RQ009 LODO evidence source is `reports/studies/RQ009_dynamic_counterpart_conditioned_envelope/RQ009_1_dynamic_envelope_20260625T121905Z_98c433de/02_process/05_evaluation/lodo_results.csv`, filter `tier == M2` and `alpha_label == 90`. Held-out sources are `av2_motion_forecasting`, `lyft_train_full`, `nuplan_train`, `waymo_train`. The 90 nominal coverage column ranges from 0.748432719519 to 0.992100195464 under that filter.

| heldout_source | coverage column | n / total_n | abstained_n / total_n | fit_sources |
|---|---:|---:|---:|---|
| `av2_motion_forecasting` | 0.965903873297 | 176413 / 295826 | 119413 / 295826 | `lyft_train_full;nuplan_train;waymo_train` |
| `lyft_train_full` | 0.748432719519 | 906028 / 1031454 | 125426 / 1031454 | `av2_motion_forecasting;nuplan_train;waymo_train` |
| `nuplan_train` | 0.992100195464 | 1452441 / 1756396 | 303955 / 1756396 | `av2_motion_forecasting;lyft_train_full;waymo_train` |
| `waymo_train` | 0.790245450787 | 3112681 / 3313590 | 200909 / 3313590 | `av2_motion_forecasting;lyft_train_full;nuplan_train` |
...
Negative control: rule `geometry_path_category nonnull must equal all-valid anchor row count` on `data/derived/onsite_competition/RQ012B_event_harm/stage3plus/onsite_anchors_multi/onsite_m3_av_anchors_multi_allvalid.parquet` column `geometry_path_category` normally gives `PASS` with 67861/67861. I deliberately changed the expected total to 67862; output: `FAIL: geometry_path_category nonnull 67861 != disturbed expected 67862`.
...
timestamp_utc: 2026-08-03T16:28:28Z
