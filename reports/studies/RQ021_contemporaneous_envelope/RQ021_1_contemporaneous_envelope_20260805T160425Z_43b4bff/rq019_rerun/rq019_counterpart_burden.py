...
def load_analysis_inputs(root: Path) -> tuple[pd.DataFrame, pd.DataFrame, dict[str, Any]]:
    ...
    score_path = root / (
        ".codex-fleet/rq021-contemporaneous-envelope/work/E1/"
    ...
    expected_90 = {"upper": 869, "lower": 519, "inside": 12711}
...
def main() -> None:
    ...
    report_path = root / (
        ".codex-fleet/rq021-contemporaneous-envelope/work/E1/rq019_rerun/"
