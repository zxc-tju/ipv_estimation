...
LAUNCHER_SHA256=68201efe27e39c81e90eb1543b3ba915a4e40f79f0554877d85574d289c621c6
PREFLIGHT_SHA256=e188c5b25c8f71bd60325f6d82a959e8332f033c61f5baf1d33a04bb9d1d3fb4
...
test -f "$LAUNCHER"
test ! -L "$LAUNCHER"
test "$(/usr/bin/stat -c %s "$LAUNCHER")" = 122208
test "$(digest_of "$LAUNCHER")" = "$LAUNCHER_SHA256"
test -f "$PREFLIGHT"
test ! -L "$PREFLIGHT"
test "$(/usr/bin/stat -c %s "$PREFLIGHT")" = 79028
