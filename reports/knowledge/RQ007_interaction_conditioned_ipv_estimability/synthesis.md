...
Status: accepted (study final review PASS; claims frozen in `decision.md`, 2026-06-23). Development/guard only; held-out sealed.
...
Authoritative claims: `decision.md` (C1, C2, C3).
