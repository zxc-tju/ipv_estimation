...
| RQ009 | Dynamic counterpart-conditioned human envelope | approved (greenlit 2026-06-24) | `reports/studies/RQ009_dynamic_counterpart_conditioned_envelope/` | `reports/knowledge/RQ009_dynamic_counterpart_conditioned_envelope/` | main dynamic verifier (M3); M4 self-history ablation |
...
| RQ012 | OnSite event ontology and blind-annotation readiness | blocked (Wave-A readiness decision frozen as deferral; `BLOCKED_FOR_HUMAN_LABELS`; [RQ012A report](reports/studies/RQ012_onsite_event_annotation_readiness/RQ012_1_event_annotation_readiness_20260623T104749+0800_1f52ac37/90_report/index.html)) | `reports/studies/RQ012_onsite_event_annotation_readiness/` | `reports/knowledge/RQ012_onsite_event_annotation_readiness/` | realised interaction consequence / blind behaviour reference |
