...
|---|---|---|---|---|---|
| RQ001 | Online IPV interval deployability | accepted | `reports/studies/RQ001_online_ipv_interval/` | `reports/knowledge/RQ001_online_ipv_interval/` | legacy interval engineering / M4 ablation boundary |
| RQ002 | Self-anchor as group norm | accepted | `reports/studies/RQ002_self_anchor_group_norm/` | `reports/knowledge/RQ002_self_anchor_group_norm/` | verifier validity/limitations; reject self-anchor-only normative authority |
...
| RQ004 | IPV state-space conclusions | accepted | `reports/studies/RQ004_ipv_state_space/` | `reports/knowledge/RQ004_ipv_state_space/` | episode-level state organization / norm framing |
| RQ005 | NMI draft evidence gap | accepted | `reports/studies/RQ005_nmi_evidence_gap/` | `reports/knowledge/RQ005_nmi_evidence_gap/` | leakage and claim-governance boundary |
...
| RQ007 | Interaction-conditioned IPV estimability | accepted (decision frozen; dev/guard, held-out sealed) | `reports/studies/RQ007_interaction_conditioned_ipv_estimability/` | `reports/knowledge/RQ007_interaction_conditioned_ipv_estimability/` | online IPV measurement and v4.1 estimability contract |
| RQ008 | InterHub temporal IPV discovery and confirmation | accepted (negative discovery boundary frozen; Wave B frozen) | `reports/studies/RQ008_interhub_temporal_ipv_discovery/` | `reports/knowledge/RQ008_interhub_temporal_ipv_discovery/` | within-interaction temporal organization (no positive temporal law from RQ008A) |
| RQ009 | Dynamic counterpart-conditioned human envelope | complete (decision frozen 2026-06-27; marginally valid M3 envelope; robust counterpart-IPV practical null; [RQ009 report](reports/studies/RQ009_dynamic_counterpart_conditioned_envelope/RQ009_1_dynamic_envelope_20260625T121905Z_98c433de/00_entry/index.html)) | `reports/studies/RQ009_dynamic_counterpart_conditioned_envelope/` | `reports/knowledge/RQ009_dynamic_counterpart_conditioned_envelope/` | dynamic verifier boundary: context-dominant envelope; counterpart-IPV increment not supported; M4 self-history marginal |
| RQ010 | WOD-E2E tracking feasibility and human preference validity | accepted (feasibility decision frozen; `T2_FULL_TRACKING_REQUIRED`; RQ010B blocked pending access/tracking/RQ009) | `reports/studies/RQ010_wod_e2e_tracking_feasibility/` | `reports/knowledge/RQ010_wod_e2e_tracking_feasibility/` | independent human-preference validity |
| RQ011 | OnSite full-universe and run-level readiness | accepted (`READY_WITH_FROZEN_EXCLUSIONS`; outcome full 300 / replay 285 with T19 excluded; no run-level/repeated-run claims; [RQ011A report](reports/studies/RQ011_onsite_full_universe_readiness/RQ011_2_onsite_readiness_20260623T201415+0800_efdd75a5/90_report/index.html)) | `reports/studies/RQ011_onsite_full_universe_readiness/` | `reports/knowledge/RQ011_onsite_full_universe_readiness/` | matched-scenario algorithm validity readiness |
| RQ012 | OnSite event ontology and blind-annotation readiness | accepted (scope revised 2026-06-24: human blind annotation deprecated; automatic events + OnSite official outcomes); [RQ012A report](reports/studies/RQ012_onsite_event_annotation_readiness/RQ012_1_event_annotation_readiness_20260623T104749+0800_1f52ac37/90_report/index.html)); RQ012B W0 extractor-health complete (M3-independent; harm endpoint BLOCKED_PENDING_M3), [RQ012B report](reports/studies/RQ012_onsite_event_annotation_readiness/RQ012B_1_event_harm_20260625T202307+0800_38f47437/00_entry/index.html) | `reports/studies/RQ012_onsite_event_annotation_readiness/` | `reports/knowledge/RQ012_onsite_event_annotation_readiness/` | realised interaction consequence / blind behaviour reference |
