...
| **RQ009** | Dynamic counterpart-conditioned human envelope | `approved` | S1 | **P0** | Greenlit 2026-06-24. New primary model is M3: context + counterpart current IPV; M4 self-history is ablation only | Depends on RQ007 estimability contract and selected RQ008 temporal variables | Draft after RQ007 inventory and RQ008 discovery protocol |
