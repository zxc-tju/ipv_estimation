...
round4 output files listed at the end. Everything else is read-only.
...
- Manuscript: `manuscript_ad18609.txt` (pdftotext of the reviewed PDF); LaTeX source at
...
2. `ROUND4_REVISION_PLAN.md` — the executable plan per §4 above.
...
## Inputs correction
- Manuscript text: `manuscript_ad18609.txt` (pdftotext of the round-3 PDF, 35 pages). LaTeX at the
...
## Outputs (write ONLY these four files, in this directory)
`AGGREGATION.md`, `ROUND4_REVISION_PLAN.md` (plan ids S01, S02, ...), `BACKLOG_delta.md`
...
## Inputs correction
- Manuscript text: `manuscript_ad18609.txt` (36 pages). LaTeX at paper repo `main.tex` = HEAD ad18609.
...
`AGGREGATION.md`, `ROUND4_REVISION_PLAN.md` (plan ids U01, U02, ...), `BACKLOG_delta.md` (B27+),
