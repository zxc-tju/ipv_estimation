...
OUT = Path(__file__).resolve().parent / "rq018_old_extended_verification.json"

RQ017 = REPO / "data/derived/rq017_onsite_gate/l1_v1"
M2 = REPO / ".codex-fleet/rq016c-human-only-envelope/work/H2/onsite_scoring_dryrun.parquet"
ANCHORS = (
    REPO
