...
RQ018_DIR = (
    REPO / "reports/studies/RQ018_abnormal_ipv_degradation"
    / "RQ018_1_association_20260804T224427Z_276cf4c"
)
RQ019_DIR = (
    REPO / "reports/studies/RQ019_counterpart_burden"
...
def main() -> None:
    ...
    sys.path.insert(0, str(REPO / ".codex-fleet/rq018-abnormal-ipv-degradation/work/A1_supervisor"))
