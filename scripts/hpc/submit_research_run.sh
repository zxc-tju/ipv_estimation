...
LAUNCHER_SHA256=89e87fcb721e6c785803e414526ce3b751a2ccc87e3b026b02f8e23e7043f3fe
PREFLIGHT_SHA256=dce18f8c7f1fbf8f8dee2d4c5b726260a9acba988b5181e4948b991c748af794
...
test -f "$LAUNCHER"
test ! -L "$LAUNCHER"
test "$(/usr/bin/stat -c %s "$LAUNCHER")" = 122879
test "$(digest_of "$LAUNCHER")" = "$LAUNCHER_SHA256"
test -f "$PREFLIGHT"
test ! -L "$PREFLIGHT"
test "$(/usr/bin/stat -c %s "$PREFLIGHT")" = 79627
