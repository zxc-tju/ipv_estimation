...
LAUNCHER_SHA256=e168c788d483542de18a123137ac037e7b08263904f90af4a7977834c0876562
PREFLIGHT_SHA256=844ba970413de71bdd0c4106de0d81ad11cd854b537c350c3963a9371dd86b95
...
test -f "$LAUNCHER"
test ! -L "$LAUNCHER"
test "$(/usr/bin/stat -c %s "$LAUNCHER")" = 119653
test "$(digest_of "$LAUNCHER")" = "$LAUNCHER_SHA256"
test -f "$PREFLIGHT"
test ! -L "$PREFLIGHT"
test "$(/usr/bin/stat -c %s "$PREFLIGHT")" = 69473
