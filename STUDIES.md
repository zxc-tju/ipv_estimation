...
| RQ014 | WOD-E2E lost rating↔IPV-deviation result recovery | v1.5 FORMAL_G1_PASS; v1.6 Waves 0–3 executed 2026-07-13: HPC sync (detached 24be0827) → immutable spec → validate-only dual-parse → single submit job 1919412 COMPLETED 0:0 → rating-blind 9-file export (479/476/3, all scans 0) dual-reviewed PASS; [bounded report](reports/studies/RQ014_wod_e2e_rating_recovery/RQ014_1_declassification_export_20260712T165224Z_0e6ca130/report.md); D1 accepted; W4 authorization loops (PR #10–#14, each dual-reviewed w/ regenerated Formal G1) delivered science amendment v1.7 + lane v3 (M3-fixed, 320 cells), WOD path-type mapping freeze, cross-phase blind-anchor fix; preflight job 1924193 COMPLETED 0:0 2026-07-14, receipts+bounded report dual NO_BLOCKER ([preflight report](reports/studies/RQ014_wod_e2e_rating_recovery/RQ014_2_contract_preflight_20260714T003336Z_72dd4362/report.md)); D2 accepted — resource-pilot loop + env-closure-v4 prep authorized, hard stop before pilot submit | `reports/studies/RQ014_wod_e2e_rating_recovery/` | `reports/knowledge/RQ014_wod_e2e_rating_recovery/` | no manuscript claim; still rating-blind; preflight, 960-cell feature bank, rating join, clean replay and claim acceptance remain separately gated |
