# Reviewer charter — round 7

You are a referee for **Nature Machine Intelligence**, reviewing the research article
"Online monitoring of socially compliant autonomous driving" (39 pages including Methods and
...
- Manuscript text: `manuscript_round7.txt` in this directory (layout-preserving text extraction
...
Base commit `5288590` plus uncommitted working-tree changes; `main.tex` sha256 prefix
`8536f31a630966ac`; 39 pages; figure set regenerates pixel-identically from source and passes its
acceptance harness (73/73).
