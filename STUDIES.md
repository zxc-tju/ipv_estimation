...
| RQ009 | Estimability-aware dynamic counterpart-conditioned envelope | approved for launch; plan review first | `reports/studies/RQ009_dynamic_counterpart_conditioned_envelope/` | `reports/knowledge/RQ009_dynamic_counterpart_conditioned_envelope/` | main M3 verifier; M4 self-history ablation |
| RQ010 | WOD-E2E tracking feasibility and preference validity | feasibility accepted; signed-in pilot authorized in principle | `reports/studies/RQ010_wod_e2e_tracking_feasibility/` | `reports/knowledge/RQ010_wod_e2e_tracking_feasibility/` | human-preference validity after T2 tracking gate |
| RQ011 | OnSite full-universe readiness | accepted `READY_WITH_FROZEN_EXCLUSIONS` | `reports/studies/RQ011_onsite_full_universe_readiness/` | `reports/knowledge/RQ011_onsite_full_universe_readiness/` | first external priority after RQ009 |
| RQ012 | OnSite event ontology and blind annotation | blocked; PI deferred two-human labels | `reports/studies/RQ012_onsite_event_annotation_readiness/` | `reports/knowledge/RQ012_onsite_event_annotation_readiness/` | protocol/scaffold only |
